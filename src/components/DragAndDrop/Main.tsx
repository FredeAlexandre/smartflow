...
import { DraggableBlocks } from './DraggableBlocks.tsx';
import { DroppableZone } from './DroppableZone.tsx';
...
export const DragAndDrop = () => {
  ...
  const handleDragEnd = (event: any) => {
    if (event.over && event.over.id === 'droppable') {
      ...
      setDraggableItems([ ...draggableItems, { id: itemsLength + 3, transform: transform }])
    }
  }
